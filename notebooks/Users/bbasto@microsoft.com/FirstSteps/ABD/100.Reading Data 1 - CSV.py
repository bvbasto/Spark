...
# MAGIC %fs ls "dbfs:/mnt/MyADLS_training/wikipedia/pageviews"
...
# MAGIC %fs head "dbfs:/mnt/MyADLS_training/wikipedia/pageviews/pageviews_by_second.tsv"
...
csvFile = "/mnt/MyADLS_training/wikipedia/pageviews/pageviews_by_second.tsv"
...
csvDF2 = (spark.read                        # The DataFrameReader
   .option("header", "true")       # Use first line of all files as header
   .option("sep", "\t")            # Use tab delimiter (default is comma-separator)
   .option("inferSchema", "true")  # Automatically infer data types
   .csv(csvFile)                   # Creates a DataFrame from CSV after reading in the file
