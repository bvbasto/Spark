...
val destDataDirRoot = "/mnt/MyADLS/nyctaxi/rawDir/green-taxi" 
...
// MAGIC LOCATION '/mnt/MyADLS/nyctaxi/rawDir/green-taxi/';
...
// MAGIC %sql
// MAGIC SELECT trip_year, trip_month,trip_month,count(*) from green_taxi_trips GROUP BY trip_year, trip_month order by trip_year desc, trip_month desc
