...
val destDataDirRoot = "/mnt/MyADLS/nyctaxi/curatedDir/yellow-taxi" 
...
// MAGIC LOCATION '/mnt/MyADLS/nyctaxi/curatedDir/yellow-taxi/';
...
// MAGIC %sql
// MAGIC select trip_year,trip_month, count(*) as trip_count from taxi_db.yellow_taxi_trips_curated group by trip_year,trip_month order by trip_year,trip_month

// COMMAND ----------

// MAGIC %sql
// MAGIC SELECT trip_year,trip_month,count(*) from yellow_taxi_trips GROUP BY trip_year,trip_month ORDER BY trip_year,trip_month
