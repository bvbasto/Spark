...
val destDataDirRoot = "/mnt/MyADLS/nyctaxi/curatedDir/materialized-view" 
...
//Execution time: ~ 5 minutes for 2017
...
// MAGIC LOCATION '/mnt/MyADLS/nyctaxi/curatedDir/materialized-view/';
...
//Destination directory
val destDataDirRoot = "/mnt/MyADLS/nyctaxi/curatedDir/materialized-view-2015Green" 
...
// MAGIC %sql
// MAGIC 
// MAGIC Select * from taxi_db.green_taxi_trips_curated  limit 1
