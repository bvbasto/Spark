...
parquetFile = "/mnt/MyADLS_training/wikipedia/pagecounts/staging_parquet_en_only_clean/"
...
pagecountsEnAllDF.createOrReplaceTempView("xpto")

# COMMAND ----------

# MAGIC %sql
# MAGIC 
# MAGIC SELECT * from xpto ORDER BY requests limit 10
