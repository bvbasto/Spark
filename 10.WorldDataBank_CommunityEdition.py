...
# MAGIC %md ####a partir daqui o exercício usa os ficheiros locais
...
# MAGIC %sql
# MAGIC SELECT * FROM wdb_indicators where idIndicator like 'SI.DST.%.20' order by idindicator
...
# MAGIC     where idIndicator = 'SI.DST.05TH.20' and Ano = 2015 order by n5 desc
...
# MAGIC           order by valor desc

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM wdb_indicators where idIndicator like 'SP.DYN.LE%' order by idindicator
